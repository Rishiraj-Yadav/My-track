...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      subtitle: 'Your wealth mytrackure at a glance. Analyzing cash flow velocity and structural integrity.',
      export: 'Export',
      ...
      mytrackuralScore: 'MyTrackural Score',
      healthRating: 'Health rating',
      healthDesc: 'Based on your savings rate, leakage, and goal progress.',
      sipGrowth: 'SIP Growth Trajectory',
      sipDesc: 'Systematic Investment Portfolio Performance',
      allocationArch: 'Allocation MyTrackure',
      leakageRadar: 'Leakage Radar',
      avoidableBleed: 'Top avoidable money bleeds'
    },
    app: {
    ...
    landing: {
      ...
      testimonials: [
        ...
        [
          'MyTrack transformed my finances from overwhelming to completely managed.',
      ...
      finalPrimary: 'Start your MyTrack journey',
  ...
  hi: {
    ...
    dashboard: {
      ...
      subtitle: 'आपकी वेल्थ आर्किटेक्चर एक नज़र में। कैश फ्लो की गति और स्थिरता का विश्लेषण।',
      export: 'निर्यात',
      ...
      savingsRate: 'बचत दर',
      monthlyVelocity: 'मासिक गति',
      mytrackuralScore: 'आर्किटेक्चरल स्कोर',
      healthRating: 'हेल्थ रेटिंग',
      healthDesc: 'आपकी बचत दर, लीकेज और लक्ष्य की प्रगति पर आधारित।',
      sipGrowth: 'SIP वृद्धि प्रक्षेपवक्र',
      sipDesc: 'सिस्टमैटिक इन्वेस्टमेंट पोर्टफोलियो प्रदर्शन',
      allocationArch: 'आवंटन वास्तुकला',
      leakageRadar: 'लीकेज रडार',
      avoidableBleed: 'शीर्ष अनावश्यक खर्चे'
    },
    app: {
    ...
    landing: {
      ...
      testimonials: [
        ...
        [
          'MyTrack ने मेरी finances को भारी लगने वाली चीज़ से manageable बना दिया।',
      ...
      finalPrimary: 'अपनी MyTrack यात्रा शुरू करें',
  ...
  ta: {
    ...
    dashboard: {
      title: 'நிதி கண்ணோட்டம்',
      subtitle: 'உங்கள் செல்வ கட்டமைப்பு ஒரு பார்வையில். பணப்புழக்க வேகம் மற்றும் நிலைத்தன்மையை பகுப்பாய்வு செய்தல்.',
      export: 'ஏற்றுமதி',
      ...
      monthlyVelocity: 'மாதாந்திர வேகம்',
      mytrackuralScore: 'கட்டமைப்பு மதிப்பெண்',
      healthRating: 'ஆரோக்கிய மதிப்பீடு',
      healthDesc: 'உங்கள் சேமிப்பு விகிதம், கசிவுகள் மற்றும் இலக்கு முன்னேற்றத்தின் அடிப்படையில்.',
      sipGrowth: 'SIP வளர்ச்சி பாதை',
      sipDesc: 'முறையான முதலீட்டு போர்ட்ஃபோலியோ செயல்திறன்',
      allocationArch: 'ஒதுக்கீட்டு கட்டமைப்பு',
      leakageRadar: 'கசிவு ரேடார்',
      avoidableBleed: 'மிக அதிக தேவையற்ற செலவுகள்'
    },
    app: {
    ...
    landing: {
      ...
      testimonials: [
        ...
        [
          'MyTrack என் finances-ஐ குழப்பத்திலிருந்து கட்டுப்பாட்டுக்குள் கொண்டு வந்தது.',
      ...
      finalPrimary: 'உங்கள் MyTrack பயணத்தை தொடங்கு',
  ...
  bn: {
    ...
    dashboard: {
      title: 'আর্থিক ওভারভিউ',
      subtitle: 'এক নজরে আপনার ওয়েলথ আর্কিটেকচার। ক্যাশ ফ্লো গতি এবং স্থায়িত্ব বিশ্লেষণ।',
      export: 'রফতানি',
      downloadPdf: 'PDF ডাউনলোড করুন',
      exportCsv: 'CSV রফতানি করুন',
      totalSpending: 'মোট খরচ',
      trailing30Days: 'গত ৩০ দিন',
      savingsRate: 'সঞ্চয়ের হার',
      monthlyVelocity: 'মাসিক গতি',
      mytrackuralScore: 'আর্কিটেকচারাল স্কোর',
      healthRating: 'হেলথ রেটিং',
      healthDesc: 'আপনার সঞ্চয় হার, ফুটো এবং লক্ষ্য অগ্রগতির উপর ভিত্তি করে।',
      sipGrowth: 'SIP বৃদ্ধির গতিপথ',
      sipDesc: 'সিস্টেমেটিক ইনভেস্টমেন্ট পোর্টফোলিও পারফরম্যান্স',
      allocationArch: 'অ্যালোকেশন আর্কিটেকচার',
      leakageRadar: 'লিকেজ রাডার',
      avoidableBleed: 'শীর্ষ এড়ানো যায় এমন খরচ'
    },
    app: {
    ...
    landing: {
      ...
      testimonials: [
        ...
        [
          'MyTrack আমার finances-কে overwhelming থেকে manageable করে দিয়েছে।',
      ...
      finalPrimary: 'আপনার MyTrack যাত্রা শুরু করুন',
