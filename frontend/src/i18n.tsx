...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      subtitle: 'Your wealth architecture at a glance. Analyzing cash flow velocity and structural integrity.',
      export: 'Export',
      ...
      allocationArch: 'Allocation Architecture',
  ...
  hi: {
    ...
    dashboard: {
      ...
      architecturalScore: 'आर्किटेक्चरल स्कोर',
  ...
  ta: {
    ...
    dashboard: {
      ...
      architecturalScore: 'கட்டமைப்பு மதிப்பெண்',
  ...
  bn: {
    ...
    dashboard: {
      ...
      architecturalScore: 'আর্কিটেকচারাল স্কোর',
