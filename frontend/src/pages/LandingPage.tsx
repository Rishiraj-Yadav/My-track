      ...
      <section className="relative min-h-[85vh] flex flex-col md:flex-row items-center justify-between gap-12 mb-32 -mt-10">
        <div className="w-full md:w-3/5 z-10 flex flex-col items-start gap-8 relative">
          ...
          <div className="flex flex-col sm:flex-row gap-6 mt-4 w-full sm:w-auto">
            <Link to="/dashboard" className="bg-gradient-to-br from-primary to-[#008f62] text-on-primary font-headline font-bold text-lg px-10 py-5 rounded-xl shadow-[0_20px_40px_rgba(78,222,163,0.2)] hover:scale-[1.02] active:scale-[0.98] transition-all duration-300 text-center">
              Start Tracking
            </Link>
