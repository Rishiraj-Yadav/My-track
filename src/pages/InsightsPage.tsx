...
export function InsightsPage() {
  ...
  const recs = [
    { label: 'Cut Swiggy twice a week', value: formatCompactINR(3500) },
    { label: 'Drop one OTT subscription', value: formatCompactINR(1299) },
    { label: 'Move cloud storage to shared plan', value: formatCompactINR(299) },
  ]
